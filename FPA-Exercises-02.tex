...
\overview{In this problem set, you develop FPT algorithms using the \enquote{trivial} method as well as using the bounded search tree method.}

\instructions

\begin{skill}[\enquote{Trivial} FPT][\mandatory]
...
\begin{skill}[Bounded search trees][\mandatory]
